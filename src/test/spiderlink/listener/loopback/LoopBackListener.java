 ...
 * </pre>
 *******************************************************************
 * $Id: LoopBackListener.java,v 1.1 2018/01/15 03:39:48 cvs Exp $
 * $Log: LoopBackListener.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.3  2006/09/27 10:25:54  이종원
 * *** empty log message ***
 *
...
public class LoopBackListener {
     ...
     * 생성자
     */
    public LoopBackListener(int listenPort) {
    ...
    public void service() {
        ...
        while (serverSocket != null && !serverSocket.isClosed()) {
            try {
                ...
                new LoopBackServiceThread(socket, logConfig).start();
    ...
    public static void main(String[] args) {
        ...
        LoopBackListener server = new LoopBackListener(port);
