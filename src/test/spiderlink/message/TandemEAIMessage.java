 ...
 * All rights reserved.
 *******************************************************************
 * $Id: TandemEAIMessage.java,v 1.1 2018/01/15 03:39:52 cvs Exp $
 * 
 * $Log: TandemEAIMessage.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.1  2007/11/26 08:37:47  안경아
 * *** empty log message ***
 *
...
/**
 * <p>Title : com.keb.stpa.engine.msg.TandemEAIMessage</p>
 * <p>Created Date & Time : 2006. 6. 29. 오후 1:0:43</p>
 * <p>Description : Tandem헤더를 포함한 EAI 전문을 나타내는 클래스</p>
 * <p>Copyright : (c) 2003-2004 by COMAS, Inc.</p>
 * <p>Company : Serverside, Inc.</p>
 * @author Jongwon Lee (e-mail : serverside@empal.com)
 * @version 1.0
 */
public class TandemEAIMessage extends MessageBase {    
    ...
    /** 대외업무구분 [size : 2, layout order number : 54] */
    private String field54 = "E1";
    
    /** 대외기관코드 [size : 4, layout order number : 55] */
    private String field55 = "0099";
    
    /** GroupID [size : 2, layout order number : 56] */
    private String field56;
    
    /** 송수신업무구분 [size : 1, layout order number : 57] */
    private String field57;
    
    /** 시뮬레이션구분 [size : 1, layout order number : 58] */
    private String field58;
    
    /** 예비 [size : 10, layout order number : 59] */
    private String field59;
    
    DataMap map;
    
    /**
     * TandemEAIMessage 의 기본 생성자
     */
    public TandemEAIMessage() {
    }//end of constructor
    ...
    public byte [] marshall() {
        ...
        byte [] marshalledData = new byte[361 + this.data.length];
        
        int index = 0;
        
        byte [] bfield1 = FormatUtil.lPadding(Long.toString(360 + this.data.length + 1), 10, HeaderConstants.ZERO_CHAR).getBytes();
        System.arraycopy(bfield1, 0, marshalledData, index, bfield1.length);
        index += 10;
        byte [] bfield2 = FormatUtil.lPadding(Long.toString(127 + this.data.length + 1), 10, HeaderConstants.ZERO_CHAR).getBytes();
        ...
        index += 8;
        byte [] bfield54 = FormatUtil.rPadding(this.field54, 2, HeaderConstants.SPACE_CHAR).getBytes();     
        System.arraycopy(bfield54, 0, marshalledData, index, bfield54.length);
        index += 2;
        byte [] bfield55 = FormatUtil.rPadding(this.field55, 4, HeaderConstants.SPACE_CHAR).getBytes();     
        System.arraycopy(bfield55, 0, marshalledData, index, bfield55.length);
        index += 4;
        byte [] bfield56 = FormatUtil.rPadding(this.field56, 2, HeaderConstants.SPACE_CHAR).getBytes();     
        System.arraycopy(bfield56, 0, marshalledData, index, bfield56.length);
        index += 2;
        byte [] bfield57 = FormatUtil.rPadding(this.field57, 1, HeaderConstants.SPACE_CHAR).getBytes();     
        System.arraycopy(bfield57, 0, marshalledData, index, bfield57.length);
        index += 1;
        byte [] bfield58 = FormatUtil.rPadding(this.field58, 1, HeaderConstants.SPACE_CHAR).getBytes();     
        System.arraycopy(bfield58, 0, marshalledData, index, bfield58.length);
        index += 1;
        byte [] bfield59 = FormatUtil.rPadding(this.field59, 10, HeaderConstants.SPACE_CHAR).getBytes();        
        System.arraycopy(bfield59, 0, marshalledData, index, bfield59.length);
        index += 10;
    
        System.arraycopy(this.data, 0, marshalledData, index, this.data.length);
        
        this.header = new String(marshalledData, 0, 360);
    ...
    public void unmarshall(byte [] marshalledData) throws Exception{
        ...
        } else if (361 > marshalledData.length) {
            throw new Exception("Unmarshall 하려는 데이터의 길이[" + marshalledData.length + " bytes]는 361 bytes 이상이어야 합니다.");
        }//end if else
        ...
        index += 8;
        this.field54 = new String(marshalledData, index, 2);
        index += 2;
        this.field55 = new String(marshalledData, index, 4);
        index += 4;
        this.field56 = new String(marshalledData, index, 2);
        index += 2;
        this.field57 = new String(marshalledData, index, 1);
        index += 1;
        this.field58 = new String(marshalledData, index, 1);
        index += 1;
        this.field59 = new String(marshalledData, index, 10);
        index += 10;
    ...
    /**
     * 예비 을(를) 리턴합니다.
     * [size : 10, layout order number : 59]
     *
     * @return 예비
     */
    ...
    /**
     * com.keb.stpa.engine.msg.TandemEAIMessage 의 프로퍼티 값을
    ...
    public String toString() {
        ...
        buffer.append("===== TandemEAIMessage.toString() start =====\n");
        ...
        buffer.append("\n");
        buffer.append("대외업무구분").append("=[").append(this.field54).append("]");
        buffer.append("\n");
        buffer.append("대외기관코드").append("=[").append(this.field55).append("]");
        buffer.append("\n");
        buffer.append("GroupID").append("=[").append(this.field56).append("]");
        buffer.append("\n");
        buffer.append("송수신업무구분").append("=[").append(this.field57).append("]");
        buffer.append("\n");
        buffer.append("시뮬레이션구분").append("=[").append(this.field58).append("]");
        buffer.append("\n");
        buffer.append("예비").append("=[").append(this.field59).append("]");
        buffer.append("\n");
        buffer.append("data").append("=[").append((this.data == null) ? "" : new String(this.data)).append("]");
        buffer.append("\n===== TandemEAIMessage.toString() end =====");
     ...
     * 
     */
    public static class TandemEAIMessageInfo {
    ...
    }//end of static-inner-class TandemEAIMessageInfo
    ...
    public String getErrorReason() {
        return super.getErrorReason("com.keb.stpa.engine.msg.TandemEAIMessage", this.field28);
    ...
    public static byte [] setSpecificField(byte [] source, int order, byte [] replaceData) {
        System.arraycopy(replaceData, 0, source, TandemEAIMessageInfo.getSize(1, order - 1), replaceData.length);
        return source;
