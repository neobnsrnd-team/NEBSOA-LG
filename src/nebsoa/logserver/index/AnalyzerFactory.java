 ...
 * 최초 등록
 *
 * Revision 1.2  2007/08/19 12:59:15  shkim
 * *** empty log message ***
 *
 * Revision 1.1  2007/08/17 10:20:23  김승희
 * 최초 등록
 *
 *
 * </pre>
...
public class AnalyzerFactory {
	...
	public static AnalyzerFactory getInstance(){
	     if(instance==null){
	          synchronized (dummy) {
	              if(instance==null) instance = new AnalyzerFactory();
	          }
	     }
	     return instance;
	}
