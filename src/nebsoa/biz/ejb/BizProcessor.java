 ...
 * <pre>
 * 1.설명 
 * Business logic을 remote에서 (non-transactional하게)실행을 대리하는 Processor EJB
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * *** empty log message ***
 *
 * Revision 1.4  2006/08/22 01:48:19  김성균
 * *** empty log message ***
 *
...
public interface BizProcessor {
    ...
    /**
     *  Business logic을 non-tranactional하게 수행합니다.
     */
    public DataMap doBizProcess(String bizId, DataMap map) throws RemoteException,BizException;
