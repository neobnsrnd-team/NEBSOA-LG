 ...
 * <pre>
 * 1.설명 
 * Business logic 실행을 대리하는 TxBizProcessorEJB 의 Home interface
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * </pre>
 ******************************************************************/
public interface TxBizProcessorHome extends EJBHome {
	
	/**
	 * TxBizProcessorEJB 객체를 생성하여 리턴합니다.
	 * 
	 * @return 생성된 BizProcessorEJB 객체
	 ...
	 */
	public TxBizProcessorEJB create() throws RemoteException, CreateException;

}// end of BizProcessorHome