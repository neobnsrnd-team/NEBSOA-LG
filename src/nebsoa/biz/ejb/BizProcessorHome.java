 ...
 * <pre>
 * 1.설명 
 * Business logic 실행을 대리하는 BizProcessorEJB 의 Home interface
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * </pre>
 ******************************************************************/
public interface BizProcessorHome extends EJBHome {
	
	/**
	 * BizProcessorEJB 객체를 생성하여 리턴합니다.
	 * 
	 ...
	 */
	public BizProcessorEJB create() throws RemoteException, CreateException;
