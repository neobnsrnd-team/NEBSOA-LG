 ...
 *  *** empty log message ***
 *
 *  Revision 1.1  2007/02/02 08:46:30  이종원
 *  최초작성
 *
 * </pre>
 ******************************************************************************/
public abstract class AppAction implements Processor,Serializable{
     ...
     * @throws Exception
     */
    public DataMap doProcess(DataMap map) throws Exception{
        return execute(map);
    }

    public abstract DataMap execute(DataMap map)throws Exception;
}