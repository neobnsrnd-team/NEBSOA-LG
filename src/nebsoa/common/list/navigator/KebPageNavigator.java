 ...
 * *** empty log message ***
 *
 * Revision 1.1  2006/09/20 07:10:57  오재훈
 * keb용 페이징 유틸
 *
 *
 * </pre>
...
public class KebPageNavigator implements Navigator{
	int total;				// 총 게시물 수
	int totalPage;
	...
	public KebPageNavigator(){};
	
	public KebPageNavigator(HttpServletRequest request,
							HttpServletResponse response,
							int total,
							int currentPage,
							int displayCount,
	 ...
	 */
	public KebPageNavigator(int total,int currentPage,int displayCount,String url){	    
...
*/
            ...
            for(int i=startPage; i<=endPage ;i++){
            	...
            	if (i==currentPage) buf.append("<B>").append(i).append("</B>");
