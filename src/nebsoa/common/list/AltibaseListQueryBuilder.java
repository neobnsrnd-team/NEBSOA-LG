 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: AltibaseListQueryBuilder.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.1  2007/02/09 07:54:09  김승희
 * 최초등록
 *
 *
 * </pre>
 ******************************************************************/
public class AltibaseListQueryBuilder implements ListQueryBuilder {

    /**
     * 원문 쿼리를 받아서 Altibase 용 리스트 조회형 쿼리로 변환합니다.
     * 
