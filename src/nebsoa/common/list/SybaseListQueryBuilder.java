 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: SybaseListQueryBuilder.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.4  2006/09/20 03:37:03  이종원
 * import optimize
 *
 ...
 * </pre>
 ******************************************************************/
public class SybaseListQueryBuilder implements ListQueryBuilder {
    
    /**
     * 원문 쿼리를 받아서 Sybase 용 리스트 조회형 쿼리로 변환합니다.
     * 
