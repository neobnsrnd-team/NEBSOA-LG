 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: SysMonitorReportMaker.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.4  2007/09/17 05:16:51  이종원
 * *** empty log message ***
 *
 ...
 * </pre>
 ******************************************************************/
public class SysMonitorReportMaker{
...
//        LogManager.debug("레포트 생성 주기  : "+(reportCreateTerm/60000)+"분");
    ...
    public static void setNextReportTime(){
        nextReportTime = System.currentTimeMillis()+getReportCreateTerm();
