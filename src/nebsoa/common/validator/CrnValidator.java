 ...
 * *** empty log message ***
 *
 * Revision 1.1  2006/06/26 21:08:27  오재훈
 * 사업자번호 validator
 *
 *
 * </pre>
...
public class CrnValidator {
	...
	public static void validate(String data) throws InvalidException {
		...
		if (!StringUtil.isNull(data)) {
			...
			LogManager.debug("사업자번호 Validator 시작");

			if(data.length()!=10) throw new InvalidException(data);
		    ...
		    for (int i=0;i<10;i++)
		        getlist[i] = Integer.parseInt(data.substring(i,i+1));
			...
			LogManager.debug("사업자번호 Validator 끝");
		}
	}
