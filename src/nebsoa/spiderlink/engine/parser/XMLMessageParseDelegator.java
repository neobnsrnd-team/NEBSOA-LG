 ...
 * <pre>
 * 1.설명 
 * XML parsing 시 Loop 데이터를 처리하는 클래스
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: XMLMessageParseDelegator.java,v $
 ...
 * </pre>
 ******************************************************************/
public class XMLMessageParseDelegator
{
    ...
    XMLMessageParseDelegator(MessageStructure structure, String rootElement) {
