 ...
 * <pre>
 * 1.설명 
 * 올바르지 못한 input 데이터의 경우 발생되는 exception
 * - required 필드에 null 또는 "" 값이 들어오거나 코드 필드에 코드 값이 들어오지 않은 경우.
 * - 올바르지 못한 코드값이 들어온 경우
 * 
 * 2.사용법
 * 
 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: InvalidInputException.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.2  2006/06/22 06:54:25  김승희
 * 주석 수정
 *
 * Revision 1.1  2006/06/20 12:23:59  김승희
 * 최초등록
 *
 *
 * </pre>
 ******************************************************************/
public class InvalidInputException extends SysException {
