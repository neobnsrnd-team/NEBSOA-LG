 ...
 * <pre>
 * 1.설명 
 * 메시지 변환 시 매핑 코드 값이 존재하지 않을 때 발생하는 exception
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * - 변경이력 (버전/변경일시/작성자)
 * 
 * $Log: InvalidMappingCodeException.java,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.1  2006/07/10 07:14:00  김승희
 * 최초등록
 *
 *
 * </pre>
 ******************************************************************/
public class InvalidMappingCodeException extends InvalidInputException{
	public InvalidMappingCodeException(String msg){
		super(msg);
	}
}
