 ...
 * <pre>
 * 1.설명 
 * 기동 응답 전문 처리 핸들러를 만들 때 상속 받을 클래스.
 * 
 * 2.사용법
 * 
 * <font color="red">
 ...
 * </pre>
 ******************************************************************/
public interface OutMsgResHandler {

	public void handleResponse(MessageContext ctx,WorkerSocket socket)
